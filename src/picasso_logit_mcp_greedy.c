...
void picasso_logit_mcp_greedy(double *Y, double * X, double * beta, double * intcpt, int * nn, int * dd, int * ite_lamb, int * ite_cyc, int * size_act, double *lambda, int *nnlambda, double *ggamma, int *mmax_ite, double *pprec){
