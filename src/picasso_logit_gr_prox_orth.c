...
void picasso_logit_gr_prox_orth(double *Y, double * X, double * beta, double * intcpt, int * nn, int * dd, int * ite_lamb, int * ite_cyc, int * gr_size_act, double *obj, double *runt, int * gr, int * gr_nn, int * gr_size, double *lambda, int *nnlambda, double * ggamma, int *mmax_ite, double *pprec, double *LL, int *fflag){
    
    int i, k, m, n, d, gr_n, max_ite1, max_ite2, nlambda, gr_size_a, gr_size_a1, ite1, ite2, c_idx, gr_idx, flag, idx;
    double gamma, w, wn, L, prec1, prec2, ilambda, ilambda0, tmp, dif1, dif2, neg1, pos1;
    clock_t start, stop;
