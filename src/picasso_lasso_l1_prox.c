...
void picasso_lasso_l1_prox(double *Y, double * X, double * S, double * beta, double * intcpt, int * nn, int * dd, int * ite_lamb, int * ite_cyc, int * size_act, double *lambda, int *nnlambda, int *mmax_ite, double *pprec, double *LL){
    
    int i, k, m, n, d, max_ite1, max_ite2, nlambda, size_a, size_a1, ite1, ite2, c_idx;
    double prec1, prec2, ilambda, tmp, dif1, dif2, L, dbn;
