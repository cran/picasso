...
void picasso_logit_l1_greedy(double *Y, double * X, double * beta, double * intcpt, int * nn, int * dd, int * ite_lamb, int * ite_cyc, int * size_act, double *lambda, int *nnlambda, int *mmax_ite, double *pprec){
    
    int i, k, m, n, d, max_ite1, max_ite2, nlambda, size_a, size_a1, comb_flag, match, ite1, ite2, c_idx, idx;
    double w, wn, g, prec1, prec2, ilambda, tmp, dif1, dif2;
