...
void picasso_scio_prox(double * S, double * beta, int * dd, int * ite_lamb, int * ite_cyc, double *lambda, int *nnlambda, int *mmax_ite, double *pprec, double * x, int *col_cnz, int *row_idx, double *obj, double *runt, double * ggamma, double *LL, int *fflag){
    
    int i, j, k, m, d, d_sq, col, max_ite1, max_ite2, nlambda, size_a, size_a1, ite1, ite2, c_idx, cnz, flag;
