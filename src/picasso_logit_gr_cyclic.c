...
void picasso_logit_gr_cyclic(double *Y, double * X, double * beta, double * intcpt, int * nn, int * dd, int * ite1, int * gr_size_act, int * gr, int * gr_nn, int * gr_size, double *lambda, int *nnlambda, int *mmax_ite, double *pprec){
