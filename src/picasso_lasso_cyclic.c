...
void picasso_lasso_cyclic(double *Y, double * X, double * S, double * beta, double * intcpt, int * nn, int * dd, int * ite_lamb, int * ite_cyc, int * size_act, double *obj, double *runt, double *lambda, int *nnlambda, double * ggamma, int *mmax_ite, double *pprec, int *fflag, int *mmax_act_in, double *ttrunc){
    
    int i, j, k, m, n, d, max_ite1, max_ite2, nlambda, size_a, size_a1, match, ite1, ite2, c_idx, flag, max_act_in, act_in;
