...
void picasso_scio_cyclic(double * S, double * beta, int * dd, int * ite_lamb, int * ite_cyc, double *lambda, int *nnlambda, int *mmax_ite, double *pprec, double * x, int *col_cnz, int *row_idx, double *obj, double *runt, double * ggamma, int *fflag, double *ttrunc){
    
    int i, j, k, m, d, d_sq, col, max_ite, nlambda, size_a, size_a1, comb_flag, match, ite, ite1, c_idx, cnz, flag;
    double prec, ilambda, tmp, dif, gamma, ilambda1, trunc;
    clock_t start, stop;
