...
void picasso_scio_l1_greedy(double * S, double * beta, int * dd, int * ite_lamb, int * ite_cyc, double *lambda, int *nnlambda, int *mmax_ite, double *pprec, double * x, int *col_cnz, int *row_idx){
    
    int i, j, k, m, d, d_sq, col, max_ite1, max_ite2, nlambda, size_a, size_a1, comb_flag, match, ite1, ite2, c_idx, cnz, idx;
    double prec1, prec2, ilambda, tmp, dif1, dif2;
