...
void picasso_lasso_l1_stoc(double *Y, double * X, double * S, double * beta, double * intcpt, int * nn, int * dd, int * ite1, int * size_act, double *lambda, int *nnlambda, int *mmax_ite, double *pprec){
    
    int i, j, j1, k, m, n, d, max_ite, nlambda, size_a, size_a1, comb_flag, match, ite, c_idx;
    double prec, ilambda, tmp, dif, dbn;
