...
// X n by d
// beta d by p
void picasso_mvr_stoc_orth(double *Y, double * X, double * beta, double * intcpt, int * nn, int * dd, int * pp, int * ite_lamb, int * ite_cyc, int * gr_size_act, double *obj, double *runt, double *xinvc, double *lambda, int *nnlambda, double * ggamma, int *mmax_ite, double *pprec, double *uinv, int *fflag, int *mmax_act_gr_in, double *ttrunc){
    
    int i, j, j1, k, m, p, n, d, max_ite1, max_ite2, nlambda, gr_size_a, gr_size_a1, match, ite1, ite2, c_idx, flag, max_act_gr_in, act_gr_in;
