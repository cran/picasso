#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# logit.scad.stoc(): Stochastic actic set identification                           #
# Author: Xingguo Li                                                               #
...
logit.scad.stoc <- function(Y, X, lambda, nlambda, gamma, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
  ...
  str=.C("picasso_logit_scad_stoc", as.double(Y), as.double(X), 
