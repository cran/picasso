#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# scio.mcp.stoc(): Sparse Column Inverse Operator                                #
# Author: Xingguo Li                                                               #
...
scio.mcp.stoc <- function(S, lambda, nlambda, gamma, d, maxdf, prec, max.ite, verbose){
  ...
  begt=Sys.time()
  str=.C("picasso_scio_mcp_stoc", as.double(S), as.double(icov), 
