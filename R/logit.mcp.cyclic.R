#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# logit.map.cyclic(): Cyclic actic set identification                              #
# Author: Xingguo Li                                                               #
...
logit.mcp.cyclic <- function(Y, X, lambda, nlambda, gamma, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
  ...
  str=.C("picasso_logit_mcp_cyclic", as.double(Y), as.double(X), 
