#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# logit.l1.greedy(): Greedy actic set identification                               #
# Author: Xingguo Li                                                               #
...
logit.l1.greedy <- function(Y, X, lambda, nlambda, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
  ...
  str=.C("picasso_logit_l1_greedy", as.double(Y), as.double(X), 
