#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# logit.scad.prox(): Proximal gradient actic set identification                    #
# Author: Xingguo Li                                                               #
...
logit.scad.prox <- function(Y, X, lambda, nlambda, gamma, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
  ...
  str=.C("picasso_logit_scad_prox", as.double(Y), as.double(X), 
