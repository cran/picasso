#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# lasso.scad.greedy(): Greedy actic set identification                             #
# Author: Xingguo Li                                                               #
...
lasso.scad.greedy <- function(Y, X, lambda, nlambda, gamma, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
    cat("SCAD via Greedy Coordinate Descent\n")
  S = colSums(X^2)
  ...
  str=.C("picasso_lasso_scad_greedy", as.double(Y), as.double(X), as.double(S), 
