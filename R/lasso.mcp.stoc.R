#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# lasso.mcp.stoc(): Stochastic actic set identification                              #
# Author: Xingguo Li                                                               #
...
lasso.mcp.stoc <- function(Y, X, lambda, nlambda, gamma, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
  ...
  str=.C("picasso_lasso_mcp_stoc", as.double(Y), as.double(X), as.double(S), 
