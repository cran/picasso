#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# lasso.l1.greedy(): Lasso with greedy actic set identification                    #
# Author: Xingguo Li                                                               #
...
lasso.l1.greedy <- function(Y, X, lambda, nlambda, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
    cat("L1 regularization via greedy actic set identification and coordinate descent\n")
  S = colSums(X^2)
  ...
  str=.C("picasso_lasso_l1_greedy", as.double(Y), as.double(X), as.double(S), 
