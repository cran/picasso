#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# logit.scad.cyclic(): Cyclic actic set identification                             #
# Author: Xingguo Li                                                               #
...
logit.scad.cyclic <- function(Y, X, lambda, nlambda, gamma, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
  ...
  str=.C("picasso_logit_scad_cyclic", as.double(Y), as.double(X), 
