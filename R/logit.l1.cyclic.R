#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# logit.l1.cyclic(): Cyclic actic set identification                               #
# Author: Xingguo Li                                                               #
...
logit.l1.cyclic <- function(Y, X, lambda, nlambda, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
  ...
  str=.C("picasso_logit_l1_cyclic", as.double(Y), as.double(X), 
