#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# lasso.mcp.greedy(): Greedy actic set identification                              #
# Author: Xingguo Li                                                               #
...
lasso.mcp.greedy <- function(Y, X, lambda, nlambda, gamma, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
    cat("MCP via Greedy Coordinate Descent\n")
  S = colSums(X^2)
  ...
  str=.C("picasso_lasso_mcp_greedy", as.double(Y), as.double(X), as.double(S), 
