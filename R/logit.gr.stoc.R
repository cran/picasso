#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# logit.gr.stoc(): Stochastic actic set identification                             #
# Author: Xingguo Li                                                               #
...
logit.gr.stoc <- function(Y, X, gr, gr.n, gr.size, lambda, nlambda, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
  ...
  str=.C("picasso_logit_gr_stoc", as.double(Y), as.double(X), 
