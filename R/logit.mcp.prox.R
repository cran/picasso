#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# logit.mcp.prox(): Proximal gradient actic set identification                     #
# Author: Xingguo Li                                                               #
...
logit.mcp.prox <- function(Y, X, lambda, nlambda, gamma, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
  ...
  str=.C("picasso_logit_mcp_prox", as.double(Y), as.double(X), 
