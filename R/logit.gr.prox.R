#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# logit.gr.prox(): Proximal gradient actic set identification                      #
# Author: Xingguo Li                                                               #
...
logit.gr.prox <- function(Y, X, gr, gr.n, gr.size, lambda, nlambda, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
    cat("Group sparse logistic regression via proximal gradient actic set identification \n")
  ...
  str=.C("picasso_logit_gr_prox", as.double(Y), as.double(X), 
