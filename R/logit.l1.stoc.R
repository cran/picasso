#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# logit.l1.stoc(): Stochastic actic set identification                             #
# Author: Xingguo Li                                                               #
...
logit.l1.stoc <- function(Y, X, lambda, nlambda, n, d, max.ite, prec,verbose)
{
  if(verbose==TRUE)
  ...
  str=.C("picasso_logit_l1_stoc", as.double(Y), as.double(X), 
