#----------------------------------------------------------------------------------#
# Package: picasso                                                                  #
# scio.scad.stoc(): Sparse Column Inverse Operator                                 #
# Author: Xingguo Li                                                               #
...
scio.scad.stoc <- function(S, lambda, nlambda, gamma, d, maxdf, prec, max.ite, verbose){
  ...
  begt=Sys.time()
  str=.C("picasso_scio_scad_stoc", as.double(S), as.double(icov), 
